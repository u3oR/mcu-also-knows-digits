...
#define AI_MNIST_DATA_ACTIVATIONS_SIZES \
  { 3392, }
#define AI_MNIST_DATA_ACTIVATIONS_SIZE     (3392)
#define AI_MNIST_DATA_ACTIVATIONS_COUNT    (1)
#define AI_MNIST_DATA_ACTIVATION_1_SIZE    (3392)



#define AI_MNIST_DATA_WEIGHTS_SIZES \
  { 54056, }
#define AI_MNIST_DATA_WEIGHTS_SIZE         (54056)
#define AI_MNIST_DATA_WEIGHTS_COUNT        (1)
#define AI_MNIST_DATA_WEIGHT_1_SIZE        (54056)
